import{u as r,j as e}from"./index-DGpkqePg.js";const t={title:"Succinct Labs",description:"undefined"};function n(i){const s={a:"a",blockquote:"blockquote",code:"code",div:"div",em:"em",h1:"h1",h2:"h2",h3:"h3",header:"header",li:"li",ol:"ol",p:"p",pre:"pre",section:"section",span:"span",strong:"strong",sup:"sup",ul:"ul",...r(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(s.header,{children:e.jsxs(s.h1,{id:"succinct-labs",children:["Succinct Labs",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#succinct-labs",children:e.jsx(s.div,{"data-autolink-icon":!0})})]})}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:[`
`,e.jsx(s.p,{children:"date: 2023-02-24"}),`
`]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsx(s.p,{children:"last updated: 2023-02-24"}),`
`]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsx(s.p,{children:e.jsx(s.a,{href:"#succinct-labs",children:"Succinct Labs"})}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"#overview",children:"Overview"})}),`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"#succinct-bridge-overview",children:"Succinct Bridge Overview"})}),`
`,e.jsxs(s.li,{children:[e.jsx(s.a,{href:"#trusted-setup",children:"Trusted Setup"}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"#best-practices-for-setup",children:"Best Practices for Setup"})}),`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"#trusted-ceremony-powers-of-tau",children:"Trusted Ceremony (Powers of Tau)"})}),`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"#example-build",children:"Example Build"})}),`
`]}),`
`]}),`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"#circuits",children:"circuits"})}),`
`,e.jsxs(s.li,{children:[e.jsx(s.a,{href:"#contracts",children:"Contracts"}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"#library-contracts",children:"Library Contracts"})}),`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"#light-client-contracts",children:"Light Client Contracts"})}),`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"#bridge-contracts",children:"Bridge Contracts"})}),`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"#additional-contracts",children:"Additional Contracts"})}),`
`]}),`
`]}),`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"#relayer",children:"Relayer"})}),`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"#appendices",children:"Appendices"})}),`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"#footnotes",children:"Footnotes"})}),`
`]}),`
`]}),`
`]}),`
...
`]}),`
`,e.jsxs(s.p,{children:["Additional Information can be found in ",e.jsx(s.a,{href:"./DeepDiveOnNearBridge.md#relayers",children:"DeepDiveOnNearBridge: Relayers"})]}),`
`,e.jsxs(s.ol,{children:[`
