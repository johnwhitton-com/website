import{u as t,j as e}from"./index-DGpkqePg.js";const h={title:"Signature Schemes in Consensus Protocols",description:"undefined"};function i(r){const s={a:"a",div:"div",h1:"h1",h2:"h2",h3:"h3",h4:"h4",header:"header",li:"li",p:"p",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...t(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(s.header,{children:e.jsxs(s.h1,{id:"signature-schemes-in-consensus-protocols",children:["Signature Schemes in Consensus Protocols",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#signature-schemes-in-consensus-protocols",children:e.jsx(s.div,{"data-autolink-icon":!0})})]})}),`
...
`]}),`
`,e.jsx(s.p,{children:"*Too many links below. Need conslidation and simplify*/"}),`
`,e.jsx(s.p,{children:"*"}),`
...
`,e.jsxs(s.li,{children:[e.jsx(s.a,{href:"https://github.com/harmony-one/harmony/blob/main/crypto/bls/bls.go",children:"harmony bls"})," (go): uses ",e.jsx(s.a,{href:"https://github.com/harmony-one/bls/blob/master/readme.md",children:"harmony bls repository"}),`
`,e.jsxs(s.ul,{children:[`
...
`,e.jsxs(s.li,{children:[e.jsx(s.a,{href:"https://github.com/Snowfork/snowbridge/tree/main/relayer/crypto/secp256k1",children:"snowbridge sr25519"}),`
*/`]}),`
`]}),`
`]}),`
