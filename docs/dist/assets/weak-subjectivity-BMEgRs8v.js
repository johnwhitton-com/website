import{u as s,j as e}from"./index-DGpkqePg.js";const r={title:"Weak Subjectivity",description:"undefined"};function i(n){const t={a:"a",blockquote:"blockquote",div:"div",em:"em",h1:"h1",h2:"h2",header:"header",li:"li",ol:"ol",p:"p",section:"section",sup:"sup",ul:"ul",...s(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.header,{children:e.jsxs(t.h1,{id:"weak-subjectivity",children:["Weak Subjectivity",e.jsx(t.a,{"aria-hidden":"true",tabIndex:"-1",href:"#weak-subjectivity",children:e.jsx(t.div,{"data-autolink-icon":!0})})]})}),`
...
`]}),`
`,e.jsxs(t.li,{children:[`
`,e.jsxs(t.p,{children:[e.jsx(t.a,{href:"https://github.com/ethereum/consensus-specs/blob/master/specs/phase0/weak-subjectivity.md",children:"Phase 0 -- Weak Subjectivity Guide"}),": This document is a guide for implementing the Weak Subjectivity protections in Phase 0."]}),`
`]}),`
`]}),`
