import{u as t,j as e}from"./index-DGpkqePg.js";const r={title:"Binance Smart Chain",description:"undefined"};function i(s){const n={a:"a",blockquote:"blockquote",div:"div",em:"em",h1:"h1",h2:"h2",header:"header",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...t(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.header,{children:e.jsxs(n.h1,{id:"binance-smart-chain",children:["Binance Smart Chain",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#binance-smart-chain",children:e.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
...
`,e.jsxs(n.p,{children:["Following is an excerpt from ",e.jsx(n.a,{href:"https://github.com/bnb-chain/bnb-chain.github.io/blob/master/docs/learn/consensus.md",children:"Binance Consensus Engine documentation"})]}),`
...
`,e.jsxs(n.p,{children:["The Binance Smart chain is cloned from ",e.jsx(n.a,{href:"./ethereum-1-0.md",children:"Ethereum 1.0"})," and thus the majority of code incuding primitives, signing are similar. The key addtions are"]}),`
`,e.jsxs(n.ul,{children:[`
...
`,e.jsxs(n.p,{children:[e.jsx("a",{name:"f19",children:"[19]"})," See ",e.jsx(n.a,{href:"https://docs.bnbchain.org/docs/learn/consensus/#consensus-protocol",children:"BSC Consensus Engine documentations"})]}),`
`,e.jsxs(n.p,{children:[e.jsx("a",{name:"f20",children:"[20]"})," Following BEP-131, see a ",e.jsx(n.a,{href:"https://www.bnbchain.org/en/blog/bep131-introducing-candidate-validators-bnb-smart-chain/",children:"summary"}),`
and `,e.jsx(n.a,{href:"https://github.com/bnb-chain/BEPs/pull/131",children:"detailed specifications"}),`. Note that
the proportion of randomly selected validators may increase, as proposed in the BEP.`]}),`
`,e.jsxs(n.p,{children:[e.jsx("a",{name:"f21",children:"[21]"})," See ",e.jsx(n.a,{href:"https://github.com/bnb-chain/bsc/blob/cb9e50bdf62c6b46a71724066d39f9851181a5af/consensus/parlia/parlia.go#L546",children:"code"}),`
