import{u as i,j as e}from"./index-DGpkqePg.js";const a={title:"Crosschain Bridge Analysis - An Introduction",description:"undefined"};function s(t){const r={a:"a",blockquote:"blockquote",div:"div",em:"em",h1:"h1",h2:"h2",h3:"h3",h4:"h4",header:"header",li:"li",ol:"ol",p:"p",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...i(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(r.header,{children:e.jsxs(r.h1,{id:"crosschain-bridge-analysis---an-introduction",children:["Crosschain Bridge Analysis - An Introduction",e.jsx(r.a,{"aria-hidden":"true",tabIndex:"-1",href:"#crosschain-bridge-analysis---an-introduction",children:e.jsx(r.div,{"data-autolink-icon":!0})})]})}),`
...
`,e.jsx(r.li,{children:e.jsx(r.a,{href:"https://github.com/paritytech/xcm-format/blob/master/README.md",children:"Polkadot Cross-Consensus Message (XCM) Format"})}),`
...
`,e.jsx(r.li,{children:e.jsx(r.a,{href:"https://github.com/paritytech/parity-bridges-common/blob/master/README.md",children:"Parity Bridges Common"})}),`
`]}),`
...
`]}),`
`]}),`
`,e.jsxs(r.li,{children:[e.jsx(r.a,{href:"./ethereum-near",children:"Near Rainbow Bridge"}),": Detailed code review",`
`,e.jsxs(r.ul,{children:[`
