import{u as r,j as e}from"./index-C4iCr7ER.js";const l={title:"Ethereum Near Bridging",description:"undefined"};function i(n){const s={a:"a",blockquote:"blockquote",code:"code",div:"div",em:"em",h1:"h1",h2:"h2",h3:"h3",h4:"h4",header:"header",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...r(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(s.header,{children:e.jsxs(s.h1,{id:"ethereum-near-bridging",children:["Ethereum Near Bridging",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#ethereum-near-bridging",children:e.jsx(s.div,{"data-autolink-icon":!0})})]})}),`
...
`,e.jsx(s.p,{children:"This document reviews the Ethereum 2.0 specifications including Light Client specifications. It does a detailed review of the NEAR Rainbow Bridge implementation and also includes references to Harmony's design to support Mountain Merkle Ranges."}),`
...
`,e.jsxs(s.h2,{id:"ethereum-20-specifications",children:["Ethereum 2.0 Specifications",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#ethereum-20-specifications",children:e.jsx(s.div,{"data-autolink-icon":!0})})]}),`
`,e.jsxs(s.ul,{children:[`
...
`]}),`
`,e.jsxs(s.h2,{id:"ethereum-20-light-client-support",children:["Ethereum 2.0 Light Client Support",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#ethereum-20-light-client-support",children:e.jsx(s.div,{"data-autolink-icon":!0})})]}),`
`,e.jsx(s.p,{children:"How light client implementation and verification of ETH and ETH2 can be done via smart contracts in other protocols."}),`
`,e.jsx(s.p,{children:"For this we review three Key items"}),`
`,e.jsxs(s.ol,{children:[`
`,e.jsxs(s.li,{children:["Light Client Specifications including ",e.jsx(s.a,{href:"https://notes.ethereum.org/@vbuterin/extended_light_client_protocol",children:"Extended light client protocol"})," described by ",e.jsx(s.a,{href:"https://github.com/ethereum/consensus-specs/blob/dev/specs/altair/light-client/sync-protocol.mdx",children:"Altair Light Client -- Sync Protocol"})," and the ",e.jsx(s.a,{href:"https://github.com/ethereum/portal-network-specs",children:"The Portal Network Specification"})]}),`
`,e.jsxs(s.li,{children:["Near Rainbow Bridge Light Client Walkthrough include ",e.jsx(s.a,{href:"https://github.com/aurora-is-near/rainbow-bridge/tree/master/eth2near/eth2near-block-relay-rs",children:"eth2near-block-relay-rs"}),", ",e.jsx(s.a,{href:"https://github.com/aurora-is-near/rainbow-bridge/tree/master/contracts/eth/nearbridge",children:"nearbridge contracts"})," and ",e.jsx(s.a,{href:"https://github.com/aurora-is-near/rainbow-bridge/tree/master/contracts/eth/nearprover",children:"nearprover contracts"})]}),`
`,e.jsxs(s.li,{children:["Prysm light-client ",e.jsx(s.a,{href:"https://github.com/jinfwhuang/prysm/tree/jin-light/cmd/light-client",children:"prototype"})]}),`
`]}),`
`,e.jsx(s.p,{children:e.jsx(s.em,{children:"Note: Time on Ethereum 2.0 Proof of Stake is divided into slots and epochs. One slot is 12 seconds. One epoch is 6.4 minutes, consisting of 32 slots. One block can be created for each slot."})}),`
`,e.jsxs(s.h3,{id:"light-client-specification",children:["Light Client Specification",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#light-client-specification",children:e.jsx(s.div,{"data-autolink-icon":!0})})]}),`
`,e.jsxs(s.h4,{id:"altair-light-client----sync-protocol",children:["Altair Light Client -- Sync Protocol",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#altair-light-client----sync-protocol",children:e.jsx(s.div,{"data-autolink-icon":!0})})]}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:[`
`,e.jsxs(s.p,{children:[e.jsx(s.a,{href:"https://github.com/ethereum/consensus-specs/blob/dev/specs/altair/light-client/sync-protocol.mdx",children:"Altair Light Client -- Sync Protocol"}),": The beacon chain is designed to be light client friendly for constrained environments to access Ethereum with reasonable safety and liveness."]}),`
`,e.jsx(s.p,{children:"Such environments include resource-constrained devices (e.g. phones for trust-minimized wallets)and metered VMs (e.g. blockchain VMs for cross-chain bridges)."}),`
`,e.jsxs(s.p,{children:["This document suggests a minimal light client design for the beacon chain thatuses sync committees introduced in ",e.jsx(s.a,{href:"https://github.com/ethereum/consensus-specs/blob/dev/specs/altair/beacon-chain.mdx",children:"this beacon chain extension"}),"."]}),`
`,e.jsx(s.p,{children:"Additional documents describe how the light client sync protocol can be used:"}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"https://github.com/ethereum/consensus-specs/blob/dev/specs/altair/light-client/full-node.mdx",children:"Full node"})}),`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"https://github.com/ethereum/consensus-specs/blob/dev/specs/altair/light-client/light-client.mdx",children:"Light client"})}),`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"https://github.com/ethereum/consensus-specs/blob/dev/specs/altair/light-client/p2p-interface.mdx",children:"Networking"})}),`
`]}),`
`]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsxs(s.p,{children:[e.jsx(s.a,{href:"https://github.com/ethereum/consensus-specs/blob/dev/specs/altair/light-client/light-client.mdx",children:"Light client sync process"}),": explains how light clients MAY obtain light client data to sync with the network."]}),`
`,e.jsxs(s.ol,{children:[`
`,e.jsxs(s.li,{children:["The light client MUST be configured out-of-band with a spec/preset (including fork schedule), with ",e.jsx(s.code,{children:"genesis_state"})," (including ",e.jsx(s.code,{children:"genesis_time"})," and ",e.jsx(s.code,{children:"genesis_validators_root"}),"), and with a trusted block root. The trusted block SHOULD be within the weak subjectivity period, and its root SHOULD be from a finalized ",e.jsx(s.code,{children:"Checkpoint"}),"."]}),`
`,e.jsxs(s.li,{children:["The local clock is initialized based on the configured ",e.jsx(s.code,{children:"genesis_time"}),", and the current fork digest is determined to browse for and connect to relevant light client data providers."]}),`
`,e.jsxs(s.li,{children:["The light client fetches a ",e.jsx(s.a,{href:"https://github.com/ethereum/consensus-specs/blob/dev/specs/altair/light-client/light-client.mdx",children:e.jsx(s.code,{children:"LightClientBootstrap"})})," object for the configured trusted block root. The ",e.jsx(s.code,{children:"bootstrap"})," object is passed to ",e.jsx(s.a,{href:"https://github.com/ethereum/consensus-specs/blob/dev/specs/altair/light-client/sync-protocol.md#initialize_light_client_store",children:e.jsx(s.code,{children:"initialize_light_client_store"})})," to obtain a local ",e.jsx(s.a,{href:"https://github.com/ethereum/consensus-specs/blob/dev/specs/altair/light-client/sync-protocol.md#lightclientstore",children:e.jsx(s.code,{children:"LightClientStore"})}),"."]}),`
`,e.jsxs(s.li,{children:["The light client tracks the sync committee periods ",e.jsx(s.code,{children:"finalized_period"})," from ",e.jsx(s.code,{children:"store.finalized_header.slot"}),", ",e.jsx(s.code,{children:"optimistic_period"})," from ",e.jsx(s.code,{children:"store.optimistic_header.slot"}),", and ",e.jsx(s.code,{children:"current_period"})," from ",e.jsx(s.code,{children:"current_slot"})," based on the local clock.",`
`,e.jsxs(s.ol,{children:[`
`,e.jsxs(s.li,{children:["When ",e.jsx(s.code,{children:"finalized_period == optimistic_period"})," and ",e.jsx(s.a,{href:"https://github.com/ethereum/consensus-specs/blob/dev/specs/altair/light-client/sync-protocol.md#is_next_sync_committee_known",children:e.jsx(s.code,{children:"is_next_sync_committee_known"})})," indicates ",e.jsx(s.code,{children:"False"}),", the light client fetches a ",e.jsx(s.a,{href:"https://github.com/ethereum/consensus-specs/blob/dev/specs/altair/light-client/sync-protocol.md#lightclientupdate",children:e.jsx(s.code,{children:"LightClientUpdate"})})," for ",e.jsx(s.code,{children:"finalized_period"}),". If ",e.jsx(s.code,{children:"finalized_period == current_period"}),", this fetch SHOULD be scheduled at a random time before ",e.jsx(s.code,{children:"current_period"})," advances."]}),`
`,e.jsxs(s.li,{children:["When ",e.jsx(s.code,{children:"finalized_period + 1 < current_period"}),", the light client fetches a ",e.jsx(s.code,{children:"LightClientUpdate"})," for each sync committee period in range ",e.jsx(s.code,{children:"[finalized_period + 1, current_period)"})," (current period excluded)"]}),`
`,e.jsxs(s.li,{children:["When ",e.jsx(s.code,{children:"finalized_period + 1 >= current_period"}),", the light client keeps observing ",e.jsx(s.a,{href:"https://github.com/ethereum/consensus-specs/blob/dev/specs/altair/light-client/sync-protocol.md#lightclientfinalityupdate",children:e.jsx(s.code,{children:"LightClientFinalityUpdate"})})," and ",e.jsx(s.a,{href:"https://github.com/ethereum/consensus-specs/blob/dev/specs/altair/light-client/sync-protocol.md#lightclientoptimisticupdate",children:e.jsx(s.code,{children:"LightClientOptimisticUpdate"})}),". Received objects are passed to ",e.jsx(s.a,{href:"https://github.com/ethereum/consensus-specs/blob/dev/specs/altair/light-client/sync-protocol.md#process_light_client_finality_update",children:e.jsx(s.code,{children:"process_light_client_finality_update"})})," and ",e.jsx(s.a,{href:"https://github.com/ethereum/consensus-specs/blob/dev/specs/altair/light-client/sync-protocol.md#process_light_client_optimistic_update",children:e.jsx(s.code,{children:"process_light_client_optimistic_update"})}),". This ensures that ",e.jsx(s.code,{children:"finalized_header"})," and ",e.jsx(s.code,{children:"optimistic_header"})," reflect the latest blocks."]}),`
`]}),`
`]}),`
`,e.jsxs(s.li,{children:[e.jsx(s.a,{href:"https://github.com/ethereum/consensus-specs/blob/dev/specs/altair/light-client/sync-protocol.md#process_light_client_store_force_update",children:e.jsx(s.code,{children:"process_light_client_store_force_update"})})," MAY be called based on use case dependent heuristics if light client sync appears stuck. If available, falling back to an alternative syncing mechanism to cover the affected sync committee period is preferred."]}),`
`]}),`
`]}),`
`]}),`
`,e.jsxs(s.h4,{id:"the-portal-network",children:["The Portal Network",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#the-portal-network",children:e.jsx(s.div,{"data-autolink-icon":!0})})]}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:[`
`,e.jsxs(s.p,{children:[e.jsx(s.a,{href:"https://github.com/ethereum/portal-network-specs",children:"The Portal Network"}),": The Portal Network is an in progess effort to enable lightweight protocol access by resource constrained devices. The term ",e.jsx(s.em,{children:'"portal"'})," is used to indicate that these networks provide a ",e.jsx(s.em,{children:"view"})," into the protocol but are not critical to the operation of the core Ethereum protocol."]}),`
`,e.jsxs(s.p,{children:["The Portal Network is comprised of multiple peer-to-peer networks which together provide the data and functionality necessary to expose the standard ",e.jsx(s.a,{href:"https://eth.wiki/json-rpc/API",children:"JSON-RPC API"}),". These networks are specially designed to ensure that clients participating in these networks can do so with minimal expenditure of networking bandwidth, CPU, RAM, and HDD resources."]}),`
`,e.jsx(s.p,{children:"The term 'Portal Client' describes a piece of software which participates in these networks. Portal Clients typically expose the standard JSON-RPC API."}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:[`
`,e.jsx(s.p,{children:"Motivation: The Portal Network is focused on delivering reliable, lightweight, and decentralized access to the Ethereum protocol."}),`
`]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsxs(s.p,{children:['Prior Work on the "Light Ethereum Subprotocol" (LES): The term "light client" has historically refered to a client of the existing ',e.jsx(s.a,{href:"https://github.com/ethereum/devp2p/blob/master/rlpx.mdx",children:"DevP2P"})," based ",e.jsx(s.a,{href:"https://github.com/ethereum/devp2p/blob/master/caps/les.mdx",children:"LES"}),' network. This network is designed using a client/server architecture. The LES network has a total capacity dictated by the number of "servers" on the network. In order for this network to scale, the "server" capacity has to increase. This also means that at any point in time the network has some total capacity which if exceeded will cause service degradation across the network. Because of this the LES network is unreliable when operating near capacity.']}),`
`]}),`
`]}),`
`]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsx(s.p,{children:"Block Relay"}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:[`
`,e.jsxs(s.p,{children:[e.jsx(s.a,{href:"https://github.com/ethereum/portal-network-specs/blob/master/beacon-chain/beacon-state-network.md#dht-overview",children:"Beacon State"}),": A client has a trusted beacon state root, and it wants to access some parts of the state. Each of the access request corresponds to some leave nodes of the beacon state. The request is a content lookup on a DHT. The response is a Merkle proof."]}),`
`,e.jsx(s.p,{children:"A Distributed Hash Table (DHT) allows network participants to have retrieve data on-demand based on a content"}),`
`]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsxs(s.p,{children:[e.jsx(s.a,{href:"https://github.com/ethereum/portal-network-specs/blob/master/beacon-chain/sync-gossip.mdx",children:"Syncing Block Headers"}),": A beacon chain client could sync committee to perform state updates. The data object LightClientSkipSyncUpdate allows a client to quickly sync to a recent header with the appropriate sync committee. Once the client establishes a recent header, it could sync to other headers by processing LightClientUpdates. These two data types allow a client to stay up-to-date with the beacon chain."]}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:[`
`,e.jsxs(s.p,{children:[e.jsx(s.a,{href:"https://github.com/ethereum/portal-network-specs/blob/master/beacon-chain/skip-sync-network.mdx",children:"Sync State"}),": A client uses SkipSyncUpdate to skip sync from a known header to a recent header. A client with a trusted but outdated header cannot use the messages in the gossip channel bc-light-client-update to update. The client's sync-committee in the stored snapshot is too old and not connected to any update messages. The client look for the appropriate SkipSyncUpdate to skip sync its header."]}),`
`]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsxs(s.p,{children:[e.jsx(s.a,{href:"https://github.com/ethereum/portal-network-specs/blob/master/beacon-chain/sync-gossip.mdx",children:"Advance Block Headers"}),": A beacon chain client could sync committee to perform ",e.jsx(s.a,{href:"https://github.com/ethereum/consensus-specs/blob/dev/specs/altair/sync-protocol.mdx",children:"state updates"}),". The data object ",e.jsx(s.a,{href:"skip-sync-network",children:"LightClientSkipSyncUpdate"})," allows a client to quickly sync to a recent header with the appropriate sync committee. Once the client establishes a recent header, it could sync to other headers by processing ",e.jsx(s.a,{href:"https://github.com/ethereum/consensus-specs/blob/dev/specs/altair/sync-protocol.md#lightclientupdate",children:"LightClientUpdates"}),". These two data types allow a client to stay up-to-date with the beacon chain."]}),`
`,e.jsxs(s.p,{children:["These two data types are placed into separate sub-networks. A light client make find-content requests on ",e.jsx(s.code,{children:"skip-sync-network"})," at start of the sync to get a header with the same ",e.jsx(s.code,{children:"SyncCommittee"})," object as in the current sync period. The client uses messages in the gossip topic ",e.jsx(s.code,{children:"bc-light-client-update"})," to advance its header."]}),`
`,e.jsxs(s.p,{children:["The gossip topics described in this document is part of a ",e.jsx(s.a,{href:"https://ethresear.ch/t/a-beacon-chain-light-client-proposal/11064",children:"proposal"})," for a beacon chain light client."]}),`
`]}),`
`]}),`
`]}),`
`]}),`
`]}),`
`]}),`
`,e.jsxs(s.h4,{id:"transaction-proofs",children:["Transaction Proofs",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#transaction-proofs",children:e.jsx(s.div,{"data-autolink-icon":!0})})]}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:[`
`,e.jsxs(s.p,{children:[e.jsx(s.a,{href:"https://github.com/ethereum/portal-network-specs/blob/master/beacon-chain/beacon-state-network.mdx",children:"Retrieving Beacon State"}),": A client has a trusted beacon state root, and it wants to access some parts of the state. Each of the access request corresponds to some leave nodes of the beacon state. The request is a content lookup on a DHT. The response is a Merkle proof."]}),`
`,e.jsx(s.p,{children:"A Distributed Hash Table (DHT) allows network participants to have retrieve data on-demand based on a content key. A portal-network DHT is different than a traditional one in that each participant could selectively limit its workload by choosing a small interest radius r. A participants only process messages that are within its chosen radius boundary."}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:[`
`,e.jsxs(s.p,{children:[e.jsx(s.a,{href:"https://github.com/ethereum/portal-network-specs/blob/master/beacon-chain/beacon-state-network.md#wire-protocol",children:"Wire Protocol"}),": For a subprotocol, we need to further define the following to be able to instantiate the wire format of each message type. 1. ",e.jsx(s.code,{children:"content_key"})," 2. ",e.jsx(s.code,{children:"content_id"})," 3. ",e.jsx(s.code,{children:"payload"})]}),`
`,e.jsxs(s.p,{children:["The content of the message is a Merkle proof contains multiple leave nodes for a ",e.jsx(s.a,{href:"https://github.com/ethereum/consensus-specs/blob/dev/specs/altair/beacon-chain.md#beaconstate",children:"BeaconState"}),"."]}),`
`,e.jsxs(s.p,{children:["Finally, we define the necessary encodings. A light client only knows the root of the beacon state. The client wants to know the details of some leave nodes. The client has to be able to construct the ",e.jsx(s.code,{children:"content_key"})," only knowing the root and which leave nodes it wants see. The ",e.jsx(s.code,{children:"content_key"})," is the ssz serialization of the paths. The paths represent the part of the beacon state that one wants to know about. The paths are represented by generalized indices. Note that ",e.jsx(s.code,{children:"hash_tree_root"})," and ",e.jsx(s.code,{children:"serialize"})," are the same as those defined in ",e.jsx(s.a,{href:"https://github.com/ethereum/portal-network-specs/blob/master/beacon-chain/sync-gossip.mdx",children:"sync-gossip"}),"."]}),`
`]}),`
`]}),`
`]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsx(s.p,{children:"TODO: Review of Retrieving a transaction proof not just retrieving data on-demand"}),`
`]}),`
`]}),`
`,e.jsxs(s.h4,{id:"references",children:["References",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#references",children:e.jsx(s.div,{"data-autolink-icon":!0})})]}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:[`
...
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"https://github.com/ethereum/consensus-specs/blob/dev/specs/altair/light-client/sync-protocol.mdx",children:"Altair Light Client -- Sync Protocol"})}),`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"https://github.com/ethereum/consensus-specs/blob/dev/specs/phase0/fork-choice.mdx",children:"Beacon Chain Fork Choice"})}),`
`,e.jsxs(s.li,{children:[e.jsx(s.a,{href:"https://github.com/ethereum/portal-network-specs",children:"The Portal Network Specification"}),": an in progess effort to enable lightweight protocol access by resource constrained devices."]}),`
`]}),`
`]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsxs(s.p,{children:[e.jsx(s.a,{href:"https://github.com/ethereum/devp2p/blob/master/caps/les.mdx",children:"Light Ethereum Subprotocol (LES)"}),': the protocol used by "light" clients, which only download block headers as they appear and fetch other parts of the blockchain on-demand.']}),`
`]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsx(s.p,{children:e.jsx(s.a,{href:"https://blockdaemon.com/blog/ethereum-altair-hard-folk-light-clients-sync-committees/",children:"BlockDaemon: Ethereum Altair Hard Folk: Light Clients & Sync Committees"})}),`
`]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsxs(s.p,{children:[e.jsx(s.a,{href:"https://docs.google.com/presentation/d/1oc_zdywOsHxz3zez1ILAgrerS7RkaF1hHoW0FLtp0Gw/edit#slide=id.p",children:"Efficient algorithms for CBC Casper"}),": Review of LMD GHOST (Latest Message Driven, Greediest Heaviest Observed Sub-Tree)"]}),`
`]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsxs(s.p,{children:[e.jsx(s.a,{href:"https://ethereum.org/en/developers/docs/data-structures-and-encoding/ssz/",children:"SSZ: Simple Serialize"}),": Overview of Simple serialize (SSZ) is the serialization method used on the Beacon Chain. (including merkalization and multiproofs)"]}),`
`]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsxs(s.p,{children:[e.jsx(s.a,{href:"https://noiseprotocol.org/noise.html",children:"The Noise Protocol Framework"}),": Noise is a framework for crypto protocols based on Diffie-Hellman key agreement."]}),`
`]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsx(s.p,{children:e.jsx(s.a,{href:"https://hackmd.io/QoLwVQf3QK6EiVt15YOYqQ?view",children:"Flashbots for Ethereum Consensus Clients"})}),`
`]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsxs(s.p,{children:[e.jsx(s.a,{href:"https://github.com/ethereum/consensus-specs/blob/dev/sync/optimistic.mdx",children:"Optimistic Sync Specification"}),": Optimistic Sync is a stop-gap measure to allow execution nodes to sync via established methods until future Ethereum roadmap items are implemented (e.g., statelessness)."]}),`
`]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsxs(s.p,{children:[e.jsx(s.a,{href:"https://hackmd.io/hsCz1G3BTyiwwJtjT4pe2Q?view",children:"Consensus Light Client Server Implementation Notes"}),": How Lodestar beacon node was tweaked to serve light clients"]}),`
`]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsxs(s.p,{children:[e.jsx(s.a,{href:"https://notes.ethereum.org/@ralexstokes/HJxDMi8vY",children:"beacon chain light client design doc"}),": notes about the design/implementation of a beacon chain light client using standard APIs and protocol features"]}),`
`]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsxs(s.p,{children:[e.jsx(s.a,{href:"https://ethresear.ch/t/a-beacon-chain-light-client-proposal/11064",children:"A Beacon Chain Light Client Proposal"}),": proposing a light client implementation that goes a step further than the minimum light client described in the altair consensus-spec. The proposed client aims to allow queries into the beacon state."]}),`
`]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsxs(s.p,{children:[e.jsx(s.a,{href:"https://github.com/ethereum/portal-network-specs/blob/master/beacon-chain/beacon-state-network.md#dht-overview",children:"Distributed Hash Table (DHT) Overview"}),": allows network participants to have retrieve data on-demand based on a content key."]}),`
`]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsxs(s.p,{children:[e.jsx(s.a,{href:"https://github.com/ethereum/consensus-specs/pull/2786",children:"(WIP) Light client p2p interface Specification"}),": a PR to get the conversation going about a p2p approach."]}),`
`]}),`
`]}),`
...
`]}),`
`,e.jsxs(s.h4,{id:"ethereum-to-near-block-propagation-flow",children:["Ethereum to NEAR block propagation flow",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#ethereum-to-near-block-propagation-flow",children:e.jsx(s.div,{"data-autolink-icon":!0})})]}),`
`,e.jsxs(s.ul,{children:[`
...
`]}),`
`]}),`
`,e.jsxs(s.h4,{id:"ethereum-to-near-block-propagation-components",children:["Ethereum to NEAR block propagation components",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#ethereum-to-near-block-propagation-components",children:e.jsx(s.div,{"data-autolink-icon":!0})})]}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:[`
...
`]}),`
`]}),`
`,e.jsxs(s.h4,{id:"ethereum-light-client-finality-update-verify-components",children:["Ethereum Light Client Finality Update Verify Components",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#ethereum-light-client-finality-update-verify-components",children:e.jsx(s.div,{"data-autolink-icon":!0})})]}),`
...
`]}),`
`]}),`
`,e.jsxs(s.h4,{id:"cryptographic-primitives",children:["Cryptographic Primitives",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#cryptographic-primitives",children:e.jsx(s.div,{"data-autolink-icon":!0})})]}),`
...
`]}),`
`,e.jsxs(s.h4,{id:"near-to-ethereum-block-propagation-costing",children:["NEAR to Ethereum block propagation costing",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#near-to-ethereum-block-propagation-costing",children:e.jsx(s.div,{"data-autolink-icon":!0})})]}),`
...
`]}),`
`,e.jsxs(s.h4,{id:"near-to-ethereum-block-propagation-flow",children:["NEAR to Ethereum block propagation flow",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#near-to-ethereum-block-propagation-flow",children:e.jsx(s.div,{"data-autolink-icon":!0})})]}),`
...
`]}),`
`]}),`
`,e.jsxs(s.h4,{id:"near-to-ethereum-watchdog",children:["NEAR to Ethereum watchdog",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#near-to-ethereum-watchdog",children:e.jsx(s.div,{"data-autolink-icon":!0})})]}),`
...
`]}),`
`]}),`
`,e.jsxs(s.h4,{id:"near-to-ethereum-block-propagation-components",children:["NEAR to Ethereum block propagation components",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#near-to-ethereum-block-propagation-components",children:e.jsx(s.div,{"data-autolink-icon":!0})})]}),`
`,e.jsxs(s.ul,{children:[`
...
`]}),`
`]}),`
`,e.jsxs(s.h4,{id:"near-rainbow-bridge-utils",children:["NEAR Rainbow Bridge Utils",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#near-rainbow-bridge-utils",children:e.jsx(s.div,{"data-autolink-icon":!0})})]}),`
...
`]}),`
`]}),`
`,e.jsxs(s.h4,{id:"nearbridge-cryptographic-primitives",children:["nearbridge Cryptographic Primitives",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#nearbridge-cryptographic-primitives",children:e.jsx(s.div,{"data-autolink-icon":!0})})]}),`
`,e.jsxs(s.ul,{children:[`
...
`,e.jsxs(s.h4,{id:"token-transfer-components",children:["Token Transfer Components",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#token-transfer-components",children:e.jsx(s.div,{"data-autolink-icon":!0})})]}),`
`,e.jsx(s.p,{children:e.jsxs(s.em,{children:["Note: This uses Ethreum ",e.jsx(s.a,{href:"https://eips.ethereum.org/EIPS/eip-20",children:"ERC20"})," and NEAR ",e.jsx(s.a,{href:"https://nomicon.io/Standards/Tokens/FungibleToken/Core",children:"NEP-141"})," initally developed for ",e.jsx(s.a,{href:"https://github.com/near/NEPs/pull/21",children:"NEP-21"})]})}),`
`,e.jsxs(s.ul,{children:[`
...
`]}),`
`]}),`
`,e.jsxs(s.h4,{id:"references-1",children:["References",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#references-1",children:e.jsx(s.div,{"data-autolink-icon":!0})})]}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:[`
`,e.jsxs(s.p,{children:[e.jsx(s.a,{href:"https://lighthouse-book.sigmaprime.io/",children:"Lighthouse Documentation"}),": ETH 2.0 Consensus Client Lighthouse documentation"]}),`
`]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsxs(s.p,{children:[e.jsx(s.a,{href:"https://github.com/sigp/lighthouse",children:"Lighthouse Github"}),": ETH 2.0 Consensus Client Lighthouse Github"]}),`
`]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsxs(s.p,{children:[e.jsx(s.a,{href:"https://lighthouse-blog.sigmaprime.io/",children:"Lighthouse: Blog"}),": ETH 2.0 Consensus Client Lighthouse Blog"]}),`
`]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsx(s.p,{children:e.jsx(s.a,{href:"https://github.com/aurora-is-near/rainbow-bridge/tree/master/eth2near/eth2near-block-relay-rs",children:"eth2near-block-relay-rs"})}),`
`]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsx(s.p,{children:e.jsx(s.a,{href:"https://github.com/aurora-is-near/rainbow-bridge/tree/master/contracts/eth/nearbridge",children:"nearbridge contracts"})}),`
`]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsx(s.p,{children:e.jsx(s.a,{href:"https://github.com/aurora-is-near/rainbow-bridge/tree/master/contracts/eth/nearprover",children:"nearprover contracts"})}),`
`]}),`
`]}),`
`,e.jsxs(s.h3,{id:"prysm-light-client",children:["Prysm Light Client",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#prysm-light-client",children:e.jsx(s.div,{"data-autolink-icon":!0})})]}),`
`,e.jsxs(s.h4,{id:"references-2",children:["References",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#references-2",children:e.jsx(s.div,{"data-autolink-icon":!0})})]}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:[`
`,e.jsxs(s.p,{children:[e.jsx(s.a,{href:"https://github.com/jinfwhuang/prysm/pull/5",children:"Prysm: Light-client (WORK IN PROGRESS)"}),":"]}),`
`]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsxs(s.p,{children:[e.jsx(s.a,{href:"https://github.com/jinfwhuang/prysm/tree/jin-light/cmd/light-client#light-client-client",children:"Prysm: Light-client Client WIP"}),": An independent light client client"]}),`
`]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsxs(s.p,{children:[e.jsx(s.a,{href:"https://github.com/prysmaticlabs/prysm/pull/10034",children:"Prysm: light-client server PR"}),": a feature PR that implements the basic production level changes to Prysm to comply as a light-client server to begin serving light client requests"]}),`
`]}),`
`]}),`
`,e.jsxs(s.h2,{id:"harmony-merkle-mount-range",children:["Harmony Merkle Mount Range",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#harmony-merkle-mount-range",children:e.jsx(s.div,{"data-autolink-icon":!0})})]}),`
`,e.jsxs(s.ul,{children:[`
...
`]}),`
`,e.jsxs(s.h2,{id:"near-rainbow-bridge-review",children:["Near Rainbow Bridge Review",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#near-rainbow-bridge-review",children:e.jsx(s.div,{"data-autolink-icon":!0})})]}),`
...
`]}),`
`]}),`
`,e.jsxs(s.h3,{id:"near-rainbow-bridge-component-overview",children:["NEAR Rainbow Bridge: Component Overview",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#near-rainbow-bridge-component-overview",children:e.jsx(s.div,{"data-autolink-icon":!0})})]}),`
...
`]}),`
`]}),`
`]})]})}function c(n={}){const{wrapper:s}={...r(),...n.components};return s?e.jsx(s,{...n,children:e.jsx(i,{...n})}):i(n)}export{c as default,l as frontmatter};
