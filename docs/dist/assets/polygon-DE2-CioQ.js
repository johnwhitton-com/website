...
`,e.jsxs(s.p,{children:["Following is an excerpt from ",e.jsx(s.a,{href:"https://github.com/maticnetwork/matic-docs/blob/master/docs/pos/polygon-architecture.md",children:"Polygon Architecture"}),"."]}),`
...
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:["A subset of active validators from the pool is selected to act as ",e.jsx(s.a,{href:"/docs/maintain/glossary#block-producer",children:"block producers"})," for a ",e.jsx(s.a,{href:"/docs/maintain/glossary#span",children:"span"}),". These block producers are responsible for creating blocks and broadcasting the created blocks on the network."]}),`
...
`,e.jsxs(s.li,{children:["A selected ",e.jsx(s.a,{href:"/docs/maintain/glossary#proposer",children:"proposer"})," from the validator set is responsible for collecting all signatures for a particular checkpoint and committing the checkpoint on the Ethereum mainnet."]}),`
...
`]}),`
`,e.jsxs(s.p,{children:["More details on Heimdall are available on the ",e.jsx(s.a,{href:"/docs/pos/heimdall/overview",children:"Heimdall architecture"})," guide."]}),`
`]}),`
...
`,e.jsxs(s.p,{children:["Following is an excerpt from and ",e.jsx(s.a,{href:"https://github.com/maticnetwork/matic-docs/blob/master/docs/pos/peppermint.md",children:"Peppermint.md"}),"."]}),`
`,e.jsxs(s.blockquote,{children:[`
...
`,e.jsx(s.a,{href:"https://wiki.polygon.technology/docs/maintain/validate/validator-responsibilities/",children:"documentations"})]})]})}function a(n={}){const{wrapper:s}={...r(),...n.components};return s?e.jsx(s,{...n,children:e.jsx(i,{...n})}):i(n)}export{a as default,o as frontmatter};
