import{u as t,j as e}from"./index-DGpkqePg.js";const o={title:"Harmony Horizon",description:"undefined"};function r(i){const n={a:"a",code:"code",div:"div",em:"em",h1:"h1",h2:"h2",h3:"h3",h4:"h4",header:"header",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...t(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.header,{children:e.jsxs(n.h1,{id:"harmony-horizon",children:["Harmony Horizon",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#harmony-horizon",children:e.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[`
`,e.jsx(n.p,{children:"date: 2023-02-24"}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx(n.p,{children:"last updated: 2023-02-24"}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx(n.p,{children:e.jsx(n.a,{href:"#harmony-horizon",children:"Harmony Horizon"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#overview",children:"Overview"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#approach",children:"Approach"})}),`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"#proving-mechanisms",children:"Proving Mechanisms"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#ethereum-light-client",children:"Ethereum Light Client"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#harmony-light-client",children:"Harmony Light Client"})}),`
`]}),`
`]}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#relayer-mechanisms",children:"Relayer Mechanisms"})}),`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"#light-client-functionality",children:"Light Client Functionality"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#ethereum-light-client-1",children:"Ethereum Light Client"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#harmony-light-client-1",children:"Harmony Light Client"})}),`
`]}),`
`]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"#token-lockers",children:"Token Lockers"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#multichain-support",children:"MultiChain Support"})}),`
`]}),`
`]}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#code-review",children:"Code Review"})}),`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"#on-chain-solidity-code-review",children:"On-chain (Solidity) Code Review"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#openzeppelin-utilities",children:"OpenZeppelin Utilities"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#cryptographic-primitives",children:"Cryptographic Primitives"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#proving-mechanisms-1",children:"Proving Mechanisms"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#token-lockers-1",children:"Token Lockers"})}),`
`]}),`
`]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"#off-chain-javascript-code-review",children:"Off-chain (Javascript) Code Review"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#on-chain-interaction",children:"On-chain interaction"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#command-line-interface",children:"Command Line Interface"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#ethereum-light-client-2",children:"Ethereum Light Client"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#proving-mechanisms-2",children:"Proving Mechanisms"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#relayer-mechanisms-1",children:"Relayer Mechanisms"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#cryptographic-primitives-1",children:"Cryptographic Primitives"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#light-client-functionality-1",children:"Light Client Functionality"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#token-lockers-2",children:"Token Lockers"})}),`
`]}),`
`]}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#references",children:"References"})}),`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"#appendices",children:"Appendices"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"#appendix-a-current-implementation-walkthough",children:"Appendix A: Current Implementation Walkthough"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#ethereum-light-client-on-harmony",children:"Ethereum Light Client (on Harmony)"})}),`
`]}),`
`]}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#mapping-tokens-ethereum-to-harmony",children:"Mapping Tokens (Ethereum to Harmony)"})}),`
`]}),`
`]}),`
`]}),`
`]}),`
...
`,e.jsxs(n.p,{children:["Further thoughs on ETH 2.0 support, removing the ETHHASH logic and SPV client and potentially replacing with MMR trees per epoch and checkpoints similar to Harmony Light Client on Ethereum, can find inspiration in ",e.jsx(n.a,{href:"./near-rainbow.md",children:"near-rainbow"}),"."]}),`
...
`,e.jsxs(n.li,{children:["ETH 2.0 support see ",e.jsx(n.a,{href:"./ETH2_0.md",children:"here"})]}),`
...
`,e.jsx(n.p,{children:e.jsxs(n.em,{children:["Note: The key difference between ",e.jsx(n.code,{children:"TokenLockerOnEthereum.sol"})," and ",e.jsx(n.code,{children:"TokenLockerOnHarmony.sol"})," is the proof validation. ",e.jsx(n.code,{children:"TokenLockerOnEthereum.sol"})," uses ",e.jsx(n.code,{children:"./lib/MMRVerifier.sol"})," to validate the ",e.jsx(n.a,{href:"https://github.com/opentimestamps/opentimestamps-server/blob/master/doc/merkle-mountain-range.md",children:"Mountain Merkle Ranges"})," on Harmony and ",e.jsx(n.code,{children:"HarmonyProver.sol"}),". ",e.jsx(n.code,{children:"TokenLockerOnHarmony.sol"})," imports ",e.jsx(n.code,{children:"./lib/MPTValidatorV2.sol"})," to validate ",e.jsx(n.a,{href:"https://ethereum.org/en/developers/docs/data-structures-and-encoding/patricia-merkle-trie/#merkle-patricia-trees",children:"Merkle Patrica Trie"})," and ",e.jsx(n.code,{children:"./EthereumLightClient.sol"}),"."]})}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"https://github.com/johnwhitton/horizon/blob/refactorV2/src/elc/README.md",children:"elc"}),": Ethereum Light Client (ELC) is a SPV-based light client implemented as a smart contract that receives and stores Ethereum block header information.",`
`,e.jsxs(n.ul,{children:[`
...
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"valid = MMRVerifier.inclusionProof(proof.root, proof.width, proof.index, blockHash, proof.peaks, proof.siblings);"})," verifys the proff using the ",e.jsx(n.a,{href:"https://github.com/opentimestamps/opentimestamps-server/blob/master/doc/merkle-mountain-range.md",children:"Merkle Mountain Range Proof"})," passed ",e.jsx(n.code,{children:"MMRVerifier.MMRProof memory proof"})," and the ",e.jsx(n.code,{children:"blockHash"}),"."]}),`
`,e.jsxs(n.li,{children:[`
...
`]})]})}function h(i={}){const{wrapper:n}={...t(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(r,{...i})}):r(i)}export{h as default,o as frontmatter};
