...
`,e.jsxs(n.p,{children:["Further thoughs on ETH 2.0 support, removing the ETHHASH logic and SPV client and potentially replacing with MMR trees per epoch and checkpoints similar to Harmony Light Client on Ethereum, can be found in ",e.jsx(n.a,{href:"./ETH2_0.md",children:"ETH2_0.md"}),"."]}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"#horizon-bridge",children:"Horizon Bridge"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#overview",children:"Overview"})}),`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"#next-steps",children:"Next Steps"}),`
`,e.jsxs(n.ul,{children:[`
...
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#transaction-sequencing",children:"Transaction Sequencing"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#bridge-functionality",children:"Bridge Functionality"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#multichain-support",children:"MultiChain Support"})}),`
`]}),`
`]}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#current-implementation-walkthough",children:"Current Implementation Walkthough"})}),`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"#ethereum-light-client-on-harmony",children:"Ethereum Light Client (on Harmony)"}),`
`,e.jsxs(n.ul,{children:[`
...
`]}),`
`]}),`
`,e.jsxs(n.li,{children:["Links to initial Design thoughs including reviews of cross chain messaging protocols and other multichain bridges can be found in ",e.jsx(n.a,{href:"./MultiChainTrustlessBridgeDraft.pdf",children:"Multichain Trustless Bridge : Draft"})]}),`
`]}),`
