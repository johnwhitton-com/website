...
`,e.jsxs(n.p,{children:["Following is an excerpt from ",e.jsx(n.a,{href:"https://github.com/tendermint/tendermint/blob/main/docs/introduction/what-is-tendermint.md",children:"What is Tendermint"})]}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"https://github.com/tendermint/tendermint/blob/main/spec/consensus/consensus.md",children:"Tendermint Byzantine Consensus Algorithm Specification"}),": Specification for Tendermints Consensus including state machine, background gossip (messaging) and proofs."]}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"https://github.com/tendermint/tendermint/blob/main/spec/consensus/proposer-selection.md",children:"Proposer Selection Procedure Specification"}),': Specifies the Proposer Selection Procedure that is used in Tendermint to choose a round proposer for its "leader-based-protocol".']}),`
`]}),`
...
`,e.jsxs(n.p,{children:[e.jsx("a",{name:"f24",children:"[24]"})," See ",e.jsx(n.a,{href:"https://tutorials.cosmos.network/academy/3-ibc/1-what-is-ibc.html",children:"Cosmos IBC documentation"})]}),`
`,e.jsxs(n.p,{children:[e.jsx("a",{name:"f25",children:"[25]"})," See ",e.jsx(n.a,{href:"https://hub.cosmos.network/main/validators/overview.html",children:"Cosmos Hub overview"})]}),`
`,e.jsxs(n.p,{children:[e.jsx("a",{name:"f26",children:"[26]"})," See ",e.jsx(n.a,{href:"https://docs.tendermint.com/v0.34/tendermint-core/validators.html#validator-keys",children:"Tendermint Core documentation"})]})]})}function a(i={}){const{wrapper:n}={...s(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(t,{...i})}):t(i)}export{a as default,o as frontmatter};
