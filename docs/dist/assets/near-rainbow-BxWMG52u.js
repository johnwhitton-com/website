...
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:[e.jsx(s.a,{href:"#near-rainbow-bridge",children:"Near Rainbow Bridge"}),`
`,e.jsxs(s.ul,{children:[`
...
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"#approach",children:"Approach"})}),`
`,e.jsxs(s.li,{children:[e.jsx(s.a,{href:"#proving-mechanisms",children:"Proving Mechanisms"}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"#near-to-ethereum-watchdog",children:"NEAR to Ethereum watchdog"})}),`
`]}),`
`]}),`
`,e.jsxs(s.li,{children:[e.jsx(s.a,{href:"#relayer-mechanisms",children:"Relayer Mechanisms"}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"#ethereum-to-near-block-propagation-flow",children:"Ethereum to NEAR block propagation flow"})}),`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"#near-to-ethereum-block-propagation-flow",children:"NEAR to Ethereum block propagation flow"})}),`
`]}),`
`]}),`
`,e.jsxs(s.li,{children:[e.jsx(s.a,{href:"#light-client-functionality",children:"Light Client Functionality"}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"#near-rainbow-bridge-ethereum-light-client-walkthrough",children:"Near Rainbow Bridge Ethereum Light Client Walkthrough"})}),`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"#near-rainbow-bridge-near-light-client-walkthrough",children:"Near Rainbow Bridge Near Light Client Walkthrough"})}),`
`]}),`
`]}),`
`,e.jsxs(s.li,{children:[e.jsx(s.a,{href:"#token-lockers",children:"Token Lockers"}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"#token-transfer-process-flow",children:"Token Transfer Process Flow"})}),`
`]}),`
`]}),`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"#multi-chain-support",children:"Multi-chain support"})}),`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"#economics",children:"Economics"})}),`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"#references",children:"References"})}),`
`,e.jsxs(s.li,{children:[e.jsx(s.a,{href:"#appendices",children:"Appendices"}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"#appendix-a---ethereum-to-near-block-propagation-components",children:"Appendix A - Ethereum to NEAR block propagation components"})}),`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"#appendix-b---ethereum-light-client-finality-update-verify-components",children:"Appendix B - Ethereum Light Client Finality Update Verify Components"})}),`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"#appendix-c---cryptographic-primitives",children:"Appendix C - Cryptographic Primitives"})}),`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"#appendix-d---near-to-ethereum-block-propagation-costing",children:"Appendix D - NEAR to Ethereum block propagation costing"})}),`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"#appendix-f---near-to-ethereum-block-propagation-components",children:"Appendix F - NEAR to Ethereum block propagation components"})}),`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"#appendix-g---near-rainbow-bridge-utils",children:"Appendix G - NEAR Rainbow Bridge Utils"})}),`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"#appendix-h---token-transfer-components",children:"Appendix H - Token Transfer Components"})}),`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"#appendix-i---near-rainbow-bridge-component-overview",children:"Appendix I - NEAR Rainbow Bridge: Component Overview"})}),`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"#appendix-j---ethereum-to-near-walkthrough",children:"Appendix J - Ethereum to NEAR Walkthrough"})}),`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"#appendix-k---explorer-and-interactive-links",children:"Appendix K - Explorer and Interactive Links"})}),`
`]}),`
`]}),`
`]}),`
`]}),`
...
`,e.jsxs(s.p,{children:["The ",e.jsx(s.a,{href:"https://near.org/bridge/",children:"NEAR Rainbow Bridge"})," uses ERC-20 connectors which are developed in ",e.jsx(s.a,{href:"https://github.com/aurora-is-near/rainbow-token-connector",children:"rainbow-token-connector"})," and ",e.jsx(s.a,{href:"https://github.com/aurora-is-near/rainbow-bridge-client",children:"rainbow-bridge-client"}),". Also see ",e.jsx(s.a,{href:"https://github.com/aurora-is-near/rainbow-bridge/blob/master/docs/workflows/eth2near-fun-transfer.md",children:"eth2near-fun-transfer.md"}),"."]}),`
...
`,e.jsx(s.strong,{children:e.jsx(s.a,{href:"https://github.com/aurora-is-near/rainbow-token-connector/blob/master/README.md",children:"Generic ERC-20/NEP-141 connector for Rainbow Bridge"})}),`
...
`,e.jsxs(s.ul,{children:[`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"https://github.com/ethereum/consensus-specs/blob/master/specs/phase0/beacon-chain.md",children:"Beacon Chain Specification"})}),`
...
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"https://github.com/ethereum/consensus-specs/blob/dev/specs/altair/light-client/light-client.md",children:"Altair Light Client -- Light Client"})}),`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"https://github.com/ethereum/consensus-specs/blob/dev/specs/altair/light-client/sync-protocol.md",children:"Altair Light Client -- Sync Protocol"})}),`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"https://github.com/ethereum/consensus-specs/blob/dev/specs/phase0/fork-choice.md",children:"Beacon Chain Fork Choice"})}),`
`]}),`
`]}),`
`,e.jsxs(s.li,{children:[`
