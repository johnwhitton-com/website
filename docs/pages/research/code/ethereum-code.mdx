...
- [Ethereum Code](#ethereum-code)
  ...
  - [Ethereum 2.0 Technical Overview](#ethereum-20-technical-overview)
    ...
    - [Checkpoints and Finality6b](#checkpoints-and-finality6b)
...
Future](https://github.com/isolab-gg/isomorph/blob/main/docs/blog/crosschain-future.md):
A review of the growing blockchain ecosystem and the role of zkp in building
trustless bridges.

<a name="ov2">[3]</a> [Technical Problems
Overview](https://github.com/isolab-gg/isomorph/blob/main/docs/problems/technical-problems-part-1.md):
...
and
[weak-subjectivity](https://github.com/ethereum/consensus-specs/blob/dev/specs/phase0/weak-subjectivity.md)
...
Validator](https://github.com/ethereum/builder-specs/blob/main/specs/validator.md):
