...
I use [jincubator](https://github.com/jincubator) for research and development of prototypes. [Here](/images/research/solving/intro) you'll find an overview of my work in 2025 on Solving, Arbitrage and Indexing, an opinionated architecture is [here](/images/research/solving/architecture). It uses [Tycho](https://docs.propellerheads.xyz/tycho/overview), Intents using [ERC-7683](https://www.erc7683.org/spec), [EIP-712](https://eips.ethereum.org/EIPS/eip-712), [Compactx](https://github.com/uniswap/compactx) and [Uniswap V4 Hooks](https://docs.uniswap.org/contracts/v4/overview).
