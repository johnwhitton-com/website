...
- Rust / Trading Infrastructure (Execution Systems, Routing, Arbitrage)
- Engineering Manager (Distributed Systems, Fintech, Platform)

## Professional Summary

Rust engineer and engineering leader specializing in low-latency trading systems, execution infrastructure, and distributed financial platforms.

Experience building real-time execution systems including arbitrage engines evaluating 1000+ routes/sec, liquidity ingestion pipelines, and cross-chain settlement infrastructure.

Track record delivering production systems across DeFi, blockchain protocols, and enterprise-scale financial platforms.
...
- Built end-to-end trading pipeline: liquidity ingestion → mapping → pricing → execution
- Designed real-time arbitrage and routing infrastructure across multiple execution paths
- Developed leverage token systems with collateral accounting and capital efficiency modeling
- Delivered multiple production systems across blockchain, DeFi, and execution infrastructure
- Led engineering teams of up to 20 developers
...
- [Layer One Protocol Research](https://github.com/johnwhitton/blockchain-eval/blob/master/substrate.mdx): jincubator: layer one protocol comparison
...
- [Demo Video](https://demo.jincubator.com): Jincubator: Intent Based Liquidity Management and Settlement Platform
...
- [DeFi Demo Video](https://youtu.be/vk0e6s_2H0w): EAVE Mobile Demo
